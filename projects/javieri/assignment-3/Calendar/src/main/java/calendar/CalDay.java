...
public class CalDay {
	...
	*/
	 ...
	 */
	//[[Despite many functions that call and cover this function, it still comes up in the test suites
	//As not covered and unreachable. Don't know why]]
	...
	//[[UNTESTABLE  Only called in constructor and unchangeable]]
	/** Sets appts */
	private void setAppts(LinkedList<Appt> appts) {
		if(appts!=null)
				this.appts = appts;
		
		if(appts!=null&&appts.size()==0)  //[[to create linked list of Appts ONLY]]
			this.appts = appts;
	}
